...
O nome correto do fundador é **Sijim**, com **M**.
...
## 2. Petatara e as cinco castas

O romance confirma uma estrutura de **cinco castas**.

A própria arquitetura da Academia Doszil reproduz a estrutura do **Petatara**: cinco níveis e uma escadaria inspirada no ramo da planta de cinco folhas.

As castas e suas denominações consolidadas são:

1. **Doszil / Doszilla** — magos pertencentes à casta Doszil.
2. **Romil / Romilla** — guerreiros.
3. **Ermucos** — burocratas, agentes administrativos e funções institucionais correlatas.
4. **Oshul / Oshulla** — artistas, entretenimento, prazer e atividades correlatas.
5. **Burnzilla / Eguzilla** — casta dos comuns.

### Burnzilla e Eguzilla

A casta dos comuns possui duas denominações:
...
O nome correto da casta é **Oshul**.
...
Uma Oshul pode sofrer sanções disciplinares aplicadas ou provocadas pela própria estrutura da casta.
...
Haler não constituem uma sexta casta.

A condição Haler pode resultar de exclusão social e também pode ser destino posterior de alguém expulso de uma casta formal.

Portanto, Haler não deve ser reduzida apenas à situação de uma pessoa que nunca entrou em casta.

---

## 5. Alukil e os eunucos

**Alukil não é uma casta separada.**

Alukil designa o **eunuco pertencente à estrutura de castas**, e a **Academia Alukil** é a instituição associada à formação desses eunucos.
...
## 6. Doszil e Academia Doszil

A Academia Doszil não funciona apenas como escola de magia.
...
O ingresso acadêmico envolve um **juramento**.

Entre os compromissos apresentados no romance estão:

- guardar segredo sobre a iniciação;
- não revelar ensinamentos mágicos;
- não revelar nomes acadêmicos sem autorização;
- reconhecer a autoridade interna da Academia;
- aderir integralmente à identidade Doszil.

Há discussão jurídica no romance segundo a qual, pelas leis de Sijim, o juramento possui peso suficiente para estabelecer pertencimento à casta Doszil.

### Nomes mágicos

Doszilla possuem **nomes mágicos ou acadêmicos**.

O romance mostra que existem regras sobre quando esses nomes devem ou podem ser declarados.

Uma disputa explícita ocorre sobre o direito de acadêmicos postergarem a confirmação desses nomes.
...
**Malnascido é uma condição jurídica permanente.**

Um malnascido é um mago que ficou fora da estrutura legítima da Academia Doszil e do Petatara formal.

Essa condição não é corrigida posteriormente por ingresso normal na Academia.
...
A condição de malnascido não constitui uma casta.

---

## 8. Categorias de mago
...
não são categorias exclusivas de malnascidos.

São **categorias ou especializações de mago**.
...
Um secador pode retirar ou “secar” Energia Criativa do ambiente, impedindo ou dificultando a realização de magia.

Essa capacidade pode neutralizar até magia de Doszilla poderosos.

### Projetores

Projetores manifestam fenômenos mágicos que podem afetar o ambiente de forma intensa e perigosa.
...
A magia utiliza uma força ou recurso chamado **Energia Criativa**.

Ela existe no ambiente e pode ser:
...
**Concentradores** são instrumentos usados para facilitar o uso da Energia Criativa.

Bastões aparecem como exemplo explícito.

### Usos tecnológicos da magia
...
- redomas de silêncio;
- portais;
- manipulação de ar e vento;
- barreiras;
- levitação;
- comunicação mental;
- objetos encantados;
- controle climático;
- arquitetura modificada por magia;
- sistemas defensivos mágicos;
- pedras mensageiras;
- tecidos e superfícies alterados magicamente.

---

## 10. Lamassus

Os **lamassus** são estátuas mágicas vinculadas à mente de Doszilla que repousam nas pirâmides.

São descritos como uma das mais poderosas linhas de defesa de Ãh-Rahresh.
...
## 12. Grão-vizirados confirmados ou mencionados

### Segurança e Guerra

**Segurança e Guerra** é o nome correto consolidado do Grão-vizirado associado a Auru e, posteriormente, Alamar.

### Segurança e Defesa

O romance contém uma referência a Auru como **Grã-vizir da Segurança e da Defesa**.

Esse nome deve permanecer registrado como **anomalia textual deliberadamente não resolvida**.

Possibilidades deixadas em aberto:

- erro da própria narrativa/personagem;
- nome anterior do Grão-vizirado;
- alteração histórica posterior;
- variação terminológica;
- outra explicação futura.

Não deve substituir **Segurança e Guerra** como nome oficial atualmente consolidado.
...
O nome correto é **Trânsito e Permanência**.
...
O registro de chegada de visitantes faz parte das funções administrativas locais.

Passaportes são utilizados nesse processo.
...
- pessoas sem passaporte podem ser detidas;
- o Estado utiliza passaportes para acompanhar circulação e existência administrativa.

Isso reforça o papel do passaporte como instrumento central de existência civil dentro do Petatara.

---

## 16. Registros e burocracia
...
A frase de que **nada acontece em Ãh-Rahresh sem ser registrado** sintetiza essa mentalidade institucional.
...
- impostos cobrados em benefício do oásis;
- contrabando;
- pagamentos não declarados;
- barganha;
- trocas em bens;
- comerciantes itinerantes;
- circuitos econômicos clandestinos.
...
Recebimentos não declarados impedem o oásis de recolher os impostos correspondentes.

### Contrabando

Algumas regiões, especialmente no Noroeste, aparecem associadas a contrabando, comércio ilegal e rotas clandestinas.
...
Escravos aparecem trabalhando em:
...
### Característica maati confirmada
...
- grandes rios;
- oásis;
- cidades subterrâneas ou parcialmente subterrâneas;
- regiões agrícolas e pastoris.
...
Esse preconceito pode atingir pessoas de castas elevadas apenas por sua origem regional.
...
Os dois nomes possuem pronúncia deliberadamente muito semelhante.

A diferença é pequena o bastante para que, no futuro, alguém que diga **Qahuad** possa parecer simplesmente estar pronunciando **Huad** de maneira defeituosa.

Essa semelhança **não é acidental**.
...
- iluminação pobre;
- casas de barro;
- crescimento ao redor de poços;
- construções muito próximas umas das outras;
- muralha reconstruída de forma precária;
- mercado junto à entrada;
- criadores de cabras;
- vendedores de queijo;
- troca de montarias;
- palácio dos sultões;
- administração local própria.

Tamareiras na entrada funcionam, segundo costume antigo, como sinal de prosperidade.
...
Yaati possui uma rede particularmente extensa e monumental.

Esses subterrâneos podem conter:
...
- salões;
- ventilação;
- iluminação mágica em áreas privilegiadas.

Há forte desigualdade de infraestrutura entre áreas dos comuns e áreas das castas superiores.
...
- escadaria em forma de Petatara;
- revestimentos de ouro;
- jardins suspensos;
- lagos artificiais;
- fontes monumentais;
- portais mágicos;
- estruturas ocultas por montanha e magia;
- sistemas de defesa integrados.
...
- pedras mensageiras;
- comunicação mental;
- amplificação mágica da voz;
- redomas de silêncio.

### Pedras mensageiras

Pedras mensageiras podem transportar mensagens físicas por grandes distâncias em poucas horas.

Possuí-las pode representar privilégio político ou recompensa por serviços prestados ao Conselho.
...
Podem ser armazenadas e transportadas em barris.
...
- pena de morte;
- execução de malnascidos;
- açoite;
- prisão;
- confisco de passaporte;
- expulsão de casta;
- sanções acadêmicas;
...
Castas superiores, especialmente Doszilla, têm acesso a:

- ambientes monumentais;
- jardins;
- iluminação mágica;
- bibliotecas;
- servos;
...
Áreas dos comuns podem ser:

- escuras;
- abafadas;
- sem iluminação mágica;
- densamente ocupadas;
...
- limites exatos entre competência local e central;
- regras completas de tributação;
- regras completas do passaporte;
- funcionamento detalhado da economia oficial;
- natureza completa das cinzas-vivas;
...
- o correto é **Oshul**;
- **Alukil** é eunuco da estrutura de castas, não uma sexta casta;
- **Burnzilla** é o nome usado pelos próprios comuns;
- **Eguzilla** é o nome usado pelas demais castas;
- projetor, comunicador e secador são **categorias de mago**, não de malnascido;
- **malnascido é condição jurídica permanente**;
- os testes Doszil destinados a malnascidos são letais;
